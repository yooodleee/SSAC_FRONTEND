...
_이 실수를 방지하기 위해 하네스에 무엇을 추가했는가?_
...
| ---------------------------- | ---------- | -------------------------------------- | --------- | ------ |
| [ML-001](mistake-log-001.md) | 2026-06-11 | 인증 토큰 플로우 반복 수정 (SSACFE-17) | 9회       | ✅     |
| [ML-002](mistake-log-002.md) | 2026-06-11 | Notion 블록 렌더러 반복 수정           | 6회       | ✅     |
| [ML-003](mistake-log-003.md) | 2026-06-11 | jest.config.js ESLint 차단 (CJS→ESM)   | 1회       | ✅     |
